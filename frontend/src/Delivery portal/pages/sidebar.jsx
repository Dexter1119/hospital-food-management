...
import { FaTasks, FaUser, FaToggleOn, FaSignOutAlt } from "react-icons/fa";
  ...
  return (
    <>
      ...
      <SidebarWrapper isOpen={isOpen}>
        <SidebarHeader>Delivery Portal</SidebarHeader>
        <NavItem onClick={() => setActiveView("profile")}>
        ...
        <NavItem onClick={() => setActiveView("update-availability")}>
          <FaToggleOn style={{ marginRight: "10px" }} />
          Completed Task
        </NavItem>
